...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://sdk.mercadopago.com", "https://http2.mlstatic.com", "https://www.googletagmanager.com", "https://www.google-analytics.com", "https://apis.google.com", "https://www.gstatic.com", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://www.google.com", "https://js.stripe.com", "https://www.youtube.com", "https://s.ytimg.com"],
      styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com"],
      fontSrc: ["'self'", "https://fonts.gstatic.com", "data:"],
      imgSrc: ["'self'", "data:", "blob:", "https:", "http:"],
      connectSrc: ["'self'", "https:", "wss:", "ws:"],
      frameSrc: ["'self'", "https://sdk.mercadopago.com", "https://accounts.google.com", "https://*.firebaseapp.com", "https://www.google.com", "https://js.stripe.com", "https://*.stripe.com", "https://www.youtube.com", "https://www.youtube-nocookie.com"],
...
app.post('/api/event/:eventId/karaoke/finish', (req, res) => {
  ...
  if (!k.currentSinger) return res.status(400).json({ error: 'Ninguem cantando agora' });
  const finished = { ...k.currentSinger, finishedAt: Date.now(), status: 'finished' };
  const VOTING_DURATION = 12000; // 12 seconds for voting
  const RESULTS_DURATION = 5000; // 5 seconds for results display
